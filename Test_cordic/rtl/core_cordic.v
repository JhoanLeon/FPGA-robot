/*  file:        cordic.v
    ...
    **NOTE** Even though there are allowances for changeing many parameters of the code, it is
    ...
    need to be computed.
	 ...
	 The core will operate in one of two modes:
...
/*  Bit accuracy for sin and cos ( 17 bits word |S|I|FFFFFFFFFFFFFFF )
...
/*  Bit accuracy for theta ( 17 bits word |S|IIIIIIII|FFFFFFFF )
...
/* CORDIC function
   ...
   VECTOR:  This mode seeks to reduce the Y values and is used to compute an angle given a point.
            Enter the sin and cos of the desired angle and the core calculates the angle. This mode computes ARCTAN.
   ROTATE:  This mode seeks to reduce the angle. It can be used to compute the sin and cos of a given angle
*/
`define ROTATE    // computes sin and cos of given angle
...
/* CORDIC GAIN
  ...
  This quickly converges to ~ 1.6467 as i goes to infinity.
...
*/
`define CORDIC_GAIN 17'd53959 // CORDIC gain = 1.6467     0 1 101001011000111 = 1.6467 = 17'd53959
`define CORDIC_1 17'd19899    // CORDIC inverse = 0.6073  0 0 100110110111011 = 0.6073 = 17'd19899 
